...
<?php $page = 'karyawan'; include  './template/header.php';
?>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="card-header">
									<h4 class="card-title">Karyawan Lapangan</h4>
								</div>
								<div class="card">
								<div class="card-body">
									<h4><a class="btn btn-primary btn-sm" href="tambah_karyawan.php">+ Tambah data</a></h4>
...
?>
								<thead>
									...
									<?php 
										...
										<td style='text-align:center;'><a class="btn btn-warning btn-sm" href="edit_karyawan.php?id=<?php echo $d['id']; ?>"><i class="far fa-edit"> Edit</i></a> | <a class="btn btn-danger btn-sm" href="./karyawan/hapus_karyawan.php?id=<?php echo $d['id']; ?>"><i class="far fa-window-close"> Hapus</i></a></td>
												 </tr>
											<?php } ?>
											</tbody>	
										</table>
