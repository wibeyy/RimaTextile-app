...
<?php $page = 'perhitungan'; include './template_manager/header.php';
?>      
...
<?php
$page = 'perhitungan'; include './template_manager/sidebar.php';
?>
...
// $bobot = array(0.30,0.20,0.30,0.20);
 ...
 //Membuatt fungsi tampilkan nama
 function getNama($id){
  include 'aksilogin/config.php';
 ...
 //Melakukan Normalisasi dengan rumus pada langkah 2
...
<?php
include './template_manager/footer.php';
?>