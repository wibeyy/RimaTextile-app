...
<?php $page = 'alternatif'; include './template_manager/header.php';
...
?>
                      ...
                      <?php while ($data = mysqli_fetch_array($sql)) {
                        ...
                        <td style='text-align:center;'><a class="btn btn-warning btn-sm" href="edit_alternatif.php?id=<?php echo $data['id_alternatif']; ?>"><i class="far fa-edit"> Edit</i></a> | <a class="btn btn-danger btn-sm" href="./alternatif/hapus_alternatif.php?id=<?php echo $data['id_alternatif']; ?>" onclick="return confirm('Yakin ingin menghapus data')"><i class="far fa-window-close"> Hapus</i></a></td>
                         </tr>
                      <?php } ?>
                      </tbody>  
                    </table>
